...
const ManagersPlan = sequelize.define('managersPlan', {
  ...
  plan: { type: DataTypes.INTEGER, defaultValue: 0, fieldType: 'number', fullName: 'План' },
  ...
  // main: { type: DataTypes.BOOLEAN, defaultValue: false, fieldType: 'boolean', fullName: 'Основной?' },
});
